...
public class OrderService {
    ...
    private void publishOrderAcceptedEvent(Order order) {
        ...
        var result = streamBridge.send("orderAccepted-out-0", orderAcceptedMessage);
        log.info("Result of sending order accepted message for order with id {}: {}", order.id(), result);
    }
